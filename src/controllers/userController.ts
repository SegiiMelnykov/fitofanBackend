...
class UserController {
    async registration(req: SighnInAndUpReq<{ email: string, password: string }>, res: TokenResponse, next: NextFunction) {
        try {
    ...
    async login(req: SighnInAndUpReq<{ email: string, password: string }>, res: TokenResponse, next: NextFunction) {
        try {
            const { email, password } = req.body;
